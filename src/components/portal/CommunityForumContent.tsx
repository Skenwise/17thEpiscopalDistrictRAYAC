...
export default function CommunityForumContent() {
  ...
  const fetchThreads = async () => {
    try {
      ...
      // Merge with default threads if Firestore is empty
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="bg-accent-red hover:bg-accent-red/90 text-white font-semibold rounded-lg px-6 py-2 transition-all"
        >
          New Thread
        </Button>
      </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <motion.div
            ...
            className="bg-slate-800 border border-accent-red/30 rounded-2xl p-8 w-full max-w-md"
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-3 rounded-xl border border-slate-600 text-slate-400 hover:text-white transition-all"
                >
                  Cancel
                </button>
                <button
