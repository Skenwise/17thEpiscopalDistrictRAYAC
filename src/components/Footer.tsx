    ...
    <footer className="w-full bg-primary text-white">
      <div className="max-w-[100rem] mx-auto px-6 md:px-12 lg:px-24 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* About Section */}
          <div>
            <h3 className="font-heading text-2xl font-bold mb-6">RAYAC</h3>
            <p className="font-paragraph text-base text-white/90 mb-6 leading-relaxed">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-white/80 hover:text-accent-orange transition-colors duration-300"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="font-paragraph text-base text-white/90 hover:text-accent-orange transition-colors duration-300"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Core Programs */}
          <div>
            <h3 className="font-heading text-xl font-bold mb-6">Core Programs</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="h-5 w-5 text-accent-orange flex-shrink-0 mt-1" />
                <span className="font-paragraph text-base text-white/90">
                  17th Episcopal District, AME Church
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="h-5 w-5 text-accent-orange flex-shrink-0 mt-1" />
                <a
              ...
              <li className="flex items-start gap-3">
                <Phone className="h-5 w-5 text-accent-orange flex-shrink-0 mt-1" />
                <span className="font-paragraph text-base text-white/90">
                  +260 XXX XXX XXX
                </span>
              </li>
        ...
        <div className="pt-8 border-t border-white/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-paragraph text-sm text-white/80 text-center md:text-left">
              © {new Date().getFullYear()} Richard Allen Young Adults Council. All rights reserved.
            </p>
            <p className="font-paragraph text-sm text-white/80 text-center md:text-right">
